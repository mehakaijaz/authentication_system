...
from account.views import (GetCSRFToken,CheckAuthenticatedView, RegistrationView,ActivateView,ActivationConfirm,ChangePasswordView,
                          DeleteAccountView,LoginView,UserDetailView,LogoutView,ResetPasswordEmailView,
